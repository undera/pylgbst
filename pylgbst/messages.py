...
class MsgHubAttachedIO(UpstreamMsg):
    ...
    DEV_MOTOR_L_CONTROL_PLUS =  0x002e
    DEV_MOTOR_XL_CONTROL_PLUS = 0x002f
    DEV_CONTROL_PLUS_TILT = 0x003b
    DEV_CONTROL_PLUS_ACCELEROMETER_A = 0x3a
    DEV_CONTROL_PLUS_ACCELEROMETER_B = 0x39
    DEV_CONTROL_PLUS_UNKNOWN_1 = 0x3c
    DEV_CONTROL_PLUS_UNKNOWN_2 = 0x36
